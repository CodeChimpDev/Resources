...
public class PetControl {
     ...
     * @author Alex Harris
     *
     * PetControl is a class to create and control pets for each player.
     * 
     * If you use this class you MUST credit myself.
     *
     */
         ...
         * creeper.setCustomName(ChatColor.GOLD + p.getDisplayName() + "'s Pet");
         * creeper.setCustomNameVisible(true);
         * PetControl.createPet(creeper, p.getUUID());
	     * 
	     */
	...
	public static void createPet(LivingEntity e, UUID toFollow) {
		try {
